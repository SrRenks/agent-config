 ...
 *
 * Discovery reads `ctx.skills` scoped to the calling agent, the same way
 * dsh-tool-skill does. Unavailable skills produce a short message, not an
 * error.
 *
 * NOTE: this plugin replaces the `dsh-tool-skill` row in the composition;
 * mounting both reinstates the catalog injection.
 */
