...
2. For EXISTING: survey docs/repository-map.md, .ai/context/index.md, .ai/project.md, docs/, and git history. Summarize what the project does: architecture, storage/database, external dependencies, local conventions.
